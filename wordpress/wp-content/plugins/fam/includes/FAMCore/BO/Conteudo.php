...
abstract class Conteudo  {
	...
	{		
		require_once(FAM_PLUGIN_PATH."/FAMCore/BO/Media.php");
	...
	public static  function GetMultiSiteContent($PostType, $options, $return_raw_post = false) {	
		...
		{	
			...
			require_once(FAM_PLUGIN_PATH . '/includes/FAMCoreVO/RelatoVO.php' );
			require_once(FAM_PLUGIN_PATH . '/includes/FAMCoreBO/Media.php' );
			require_once(FAM_PLUGIN_PATH . '/includes/FAMCoreVO/ImagemVO.php' );
			require_once(FAM_PLUGIN_PATH . '/includes/FAMCoreVO/DestaqueVO.php' );
				...
				{		
					switch($post->post_type)
					{
						...
						case "albuns":
							...
							break;
						case "blog_post":
							require_once(FAM_PLUGIN_PATH . '/includes/FAMCoreVO/PostVO.php' );
