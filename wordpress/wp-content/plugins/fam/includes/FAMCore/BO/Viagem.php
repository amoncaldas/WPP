...
require_once(FAM_PLUGIN_PATH . '/includes/FAMCoreVO/ViagemVO.php' );
require_once(FAM_PLUGIN_PATH . '/includes/FAMCoreVO/LocationVO.php' );
require_once(FAM_PLUGIN_PATH . '/includes/FAMCoreBO/Relato.php' );
...
require_once(FAM_PLUGIN_PATH . '/includes/FAMCoreBO/Viagem.php' );
