...
function add_custom_blog_form() 
{
	...
	add_meta_box('custom-metabox-mapa', __('Mapa do local'), 'location_suggestion', 'blog_post', 'normal', 'high');
...
function location_suggestion()
{	
	?><div id="locationmap" style="height:300px"></div><?php
}
