...
require_once( FAM_PLUGIN_PATH . '/includes/global/custom-content/media/media.php');

require_once( FAM_PLUGIN_PATH . '/includes/admin-pages/fam-options.php');

if (current_user_can('add_videos'))
{
	require_once( FAM_PLUGIN_PATH . '/includes/global/custom-content/media/youtube_video.php');
}	
...
CheckValidBrowser();	
require_once(FAM_PLUGIN_PATH . '/includes/FAMCoreboot.php' );
?>