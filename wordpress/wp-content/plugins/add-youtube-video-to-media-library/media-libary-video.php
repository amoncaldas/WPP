<?php
/*
Plugin Name: FAM Youtube Video to Media Library
...
if (!class_exists('mlv')) {
    class mlv {
        ...
        */
		...
		var $adminmenuRole='author';
		
		static public $adminCapability = 'upload_files';
        ...
        */
        function admin_menu_link() {
            global $mlv_dir, $mlv_base;
				add_submenu_page("upload.php", "Adicionar vídeo", "Adicionar vídeo", self::$adminCapability, $mlv_dir."/add.php");			
        }
