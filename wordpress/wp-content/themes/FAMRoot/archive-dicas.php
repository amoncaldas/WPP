		...
		<div id="content">				
			<div id="bloco-conteudo-central">				
				<div class="relatosInterna list_blog_posts blog">					
					<?php widget::Get("blog_posts", array('itens'=> 10,'show_share'=>'yes','content_lenght'=> 600,'width'=>'95%','show_more'=> 'yes','width'=>'95%')); ?>									
				</div>
				<!-- end relatos -->
				
				<aside id="coluna-lateral-direita" class="lateral_list_blogs lateral_without_title_spacer">
					<? widget::Get("add_box_top_right", array('width'=>'296','float'=>'right','margin_top'=>"10px",'label'=>'archive_blog'));  ?>
					<?php widget::Get("blog_sidebar", array('itens'=> 2,'title'=>'Relatos de viagem','content_lenght'=> 200,'width'=>'100%','show_more'=> 'yes')); ?>
					<? widget::Get("viagens", array('itens'=>2,'show_more'=>'yes','width'=>'100%','float'=>'right'));?>					
