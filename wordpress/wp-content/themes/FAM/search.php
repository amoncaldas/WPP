				...
				<div id="bloco-conteudo-central" class="search-result">				
					...
					<? 
						...
						{	
							...
							widget::Get("ultimos-relatos", array('title'=>'Últimos relatos','show_meta_data_label'=>'yes','itens'=> 8,'show_map'=>'yes','show_share'=>'yes','content_lenght'=> 600,'width'=>'96%', 'show_more'=> 'yes','show_location'=> true,'show_large_image'=>'yes'));
							?></div><?
						}
					?>					
					
					<aside id="coluna-lateral-direita" class="search_lateral" >
						<? widget::Get("add_box_top_right", array('width'=>'300','float'=>'right','margin_top'=>"0px",'label'=>'search','margin_right'=>'-5px')); ?>
						<? widget::Get("viagens", array('list_type'=>'box','itens'=>2,'show_more'=>'yes','width'=>'100%','float'=>'right'));?>						
						<?php widget::Get("blog_posts", array('itens'=> 3,'content_lenght'=> 200,'width'=>'100%','show_more'=> 'yes')); ?>
