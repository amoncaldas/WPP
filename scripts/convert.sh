# image magick required for this script https://www.imagemagick.org/script/index.php
# This is used to crop the map-marker and map-marker-radius 256x256-PNGs
